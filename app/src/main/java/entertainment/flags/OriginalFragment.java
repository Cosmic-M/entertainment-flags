...
public abstract class OriginalFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        mSoundSwitcher = view.findViewById(R.id.sound_on_or_off_id);
        ColorFilter filter = new LightingColorFilter(getResources().getColor(R.color.score_and_timer), Color.CYAN);
